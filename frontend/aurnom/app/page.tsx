...
export default function HomePage() {
  ...
  if (loading && !data) {
    return (
      <main className="dark min-h-svh bg-zinc-950 p-2 font-mono text-xs text-cyber-cyan">
  ...
  if (error && !data) {
    return (
      <main className="dark min-h-svh bg-zinc-950 p-2 font-mono text-xs text-red-400">
  ...
  if (!data) {
    return (
      <main className="dark min-h-svh bg-zinc-950 p-2 font-mono text-xs text-ui-muted">
        No data.
      </main>
    );
  }
